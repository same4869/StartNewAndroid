...
import static com.sna.xunwang.startnewandroid.view.ThumbUpView.LikeType.like;

/**
 * Created by xunwang on 16/11/25.
 */
...
public class ThumbUpView extends View {
    ...
    private void init() {
        edgeColor = Color.parseColor("#999999");
        fillColor = Color.parseColor("#ff0000");
        cracksColor = Color.parseColor("#33bbff");
        int type = 0;
    ...
    private void drawLove(Canvas canvas, Paint mPaint, float mAnimatedValue) {
        ...
        // * 0.5f;
        rectFlove.left = rectFBg.centerX() - (rectFBg.width() / 2f + mPaint.getStrokeWidth()) * mAnimatedValue;// * 0
        // .5f;
        rectFlove.right = rectFBg.centerX() + (rectFBg.width() / 2f + mPaint.getStrokeWidth()) * mAnimatedValue;//* 0
        // .5f;
...
//        path.moveTo( (float) (0.5 * realWidth) + rectFlove.left, (float) (realHeight * 0.8 + rectFlove.top));
        path.cubicTo((float) (realWidth + 0.4 * realWidth) + rectFlove.left, (float) (0.45 * realHeight) + rectFlove
                        .top,
